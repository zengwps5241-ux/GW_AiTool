...
> 面向技术团队的综合技术说明:在国科智能体平台底座之上,**AI 顾问作战台**(`consultant-war-room`)是怎么设计的、技术框架怎么搭、健壮性怎么考虑。
>
> **文档版本**:V1.0
> **编写日期**:2026-07-06
...
**AI 顾问作战台**是建在国科智能体平台(`agent-platform-main`)之上的轻咨询业务应用,让顾问在一个平台里完成"假设地图 → 拜访方案 → 现场验证 → 现状地图 → 营销地图 → 知识沉淀"的全流程闭环。
